...
<CardGroup cols={2}>
  ...
  <Card title="Adding Libraries" icon="plus" href="https://context7.com/docs/adding-libraries">
    Submit your library to Context7
  </Card>
  <Card title="Troubleshooting" icon="wrench" href="https://context7.com/docs/resources/troubleshooting">
